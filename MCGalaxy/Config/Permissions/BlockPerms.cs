...
namespace MCGalaxy.Blocks
{
    ...
    public sealed class BlockPerms : ItemPerms
    {
        ...
        public BlockPerms(ushort id, sbyte min) : base(min) => ID = id;
        ...
        static void ProcessLines(StreamReader r, BlockPerms[] list)
        {
            ...
            while ((line = r.ReadLine()) != null)
            {
                ...
                {
                    Logger.Log(6, "Hit an error on the block " + line);
                    continue;
                }
            }
        }
        static void Set(ushort b, sbyte min, BlockPerms[] list,
                        List<sbyte> allowed, List<sbyte> disallowed)
        {
        ...
        static void SetDefaultSpecialDeletePerms()
        {
            for (ushort b = Block.Water; b <= Block.StillLava; b++)
                DeleteList[b].MinRank = 0;
        }
        static sbyte DefaultPerm(ushort block) => block switch
        {
            Block.Bedrock or Block.Air_Flood or Block.Air_FloodDown or Block.Air_FloodLayer or Block.Air_FloodUp or Block.TNT_Big or Block.TNT_Nuke or Block.RocketStart or Block.RocketHead or Block.Creeper or Block.ZombieBody or Block.ZombieHead or Block.Bird_Red or Block.Bird_Killer or Block.Bird_Blue or Block.Fish_Gold or Block.Fish_Sponge or Block.Fish_Shark or Block.Fish_Salmon or Block.Fish_Betta or Block.Fish_LavaShark or Block.Snake or Block.SnakeTail or Block.FlagBase => 80,
            Block.FloatWood or Block.LavaSponge or Block.Door_Log_air or Block.Door_Green_air or Block.Door_TNT_air or Block.Water or Block.Lava or Block.FastLava or Block.WaterDown or Block.LavaDown or Block.WaterFaucet or Block.LavaFaucet or Block.FiniteWater or Block.FiniteLava or Block.FiniteFaucet or Block.Magma or Block.Geyser or Block.Deadly_Lava or Block.Deadly_Water or Block.Deadly_Air or Block.Deadly_ActiveWater or Block.Deadly_ActiveLava or Block.Deadly_FastLava or Block.LavaFire or Block.C4 or Block.C4Detonator or Block.TNT_Small or Block.TNT_Explosion or Block.Fireworks or Block.Checkpoint or Block.Train or Block.Bird_White or Block.Bird_Black or Block.Bird_Water or Block.Bird_Lava => 50,
            _ => 0,
        };
    }
}
