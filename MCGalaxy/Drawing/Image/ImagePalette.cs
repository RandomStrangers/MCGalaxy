...
namespace MCGalaxy.Drawing
{
    ...
    public sealed class ImagePalette
    {
        ...
        static readonly PaletteEntry[] Color = new PaletteEntry[] {
            ...
            new(226,  31,  38, Block.Red),
            new(223, 135,  37, Block.Orange),
            new(230, 241,  25, Block.Yellow),
            new(127, 234,  26, Block.Lime),
            new(25,  234,  20, Block.Green),
            new(31,  234, 122, Block.Teal),
            new(27,  239, 225, Block.Aqua),
            new(99,  166, 226, Block.Cyan),
            new(111, 124, 235, Block.Blue),
            new(126,  34, 218, Block.Indigo),
            new(170,  71, 219, Block.Violet),
            new(227,  39, 225, Block.Magenta),
            new(234,  39, 121, Block.Pink),
