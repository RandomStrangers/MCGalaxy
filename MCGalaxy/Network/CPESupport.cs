...
namespace MCGalaxy
{
    ...
    public class CpeExtension
    {
        ...
        public static CpeExtension[] All = new CpeExtension[] {
            ...
            new(CpeExt.BlockPermissions,    "Allows controlling which individual blocks can be placed/deleted"),
            new(CpeExt.ChangeModel,         "Allows changing models of entities (/Model)"),
            new(CpeExt.EnvMapAppearance,    "Allows customising map appearance (/Texture)", 2),
            new(CpeExt.EnvWeatherType,      "Allows customising weather (/Env)"),
            new(CpeExt.HackControl,         "Allows changing hacks permissions (e.g. speed) on the fly"),
            new(CpeExt.EmoteFix,            "Allows clients to properly render emotes"),
            new(CpeExt.MessageTypes,        "Allows messages to appear in special locations (e.g. top right)"),
            new(CpeExt.LongerMessages,      "Allows typing multiline chat in clients"),
            new(CpeExt.FullCP437,           "Allows using all code page 437 characters in chat"),
            new(CpeExt.BlockDefinitions,    "Allows defining custom blocks (/LB and /GB)"),
            new(CpeExt.BlockDefinitionsExt, "Allows defining custom blocks with more flexible shapes (/LB and /GB)", 2),
            new(CpeExt.TextColors,          "Allows customising chat color codes (/CustomColors)"),
            new(CpeExt.BulkBlockUpdate,     "Allows sending block updates in a faster way"),
            new(CpeExt.EnvMapAspect,        "Allows customising map appearance (/Env and /Texture)", 2),
            new(CpeExt.PlayerClick,         "Allows retrieving precise details on mouse clicks"),
            new(CpeExt.EntityProperty,      "Allows customising properties of entities (/EntityRot)"),
            new(CpeExt.ExtEntityPositions,  "Allows entities to appear at positions past 1023"),
            new(CpeExt.TwoWayPing,          "Allows measuring ping (/Ping)"),
            new(CpeExt.InventoryOrder,      "Allows configuring order of blocks in Inventory menu"),
            ...
            new(CpeExt.AmpersandSupport,    "Allows literal '&' in chat messages without escaping to '%'"),
