...
namespace NotAwesomeSurvival
{
    ...
    public class Mob
    {
        ...
        public static void AddAi(string ai, string[] args)
        {
            ...
            ScriptFile.Append(Player.Console, ai, args.Length > 2 ? args[2] : "", args);
        }
    ...
    public class HostileInstruction : BotInstruction
    {
        ...
        public override bool Execute(PlayerBot bot, InstructionData data)
        {
            ...
            Player closest = Mob.ClosestPlayer(bot, search);
            switch (closest)
            {
                case null:
                    if (meta.walkTime > 0)
    ...
    public class RoamInstruction : BotInstruction
    {
        ...
        public void DoStuff(PlayerBot bot, MobMetadata meta)
        {
            ...
            {
                meta.walkTime = walkTime;
                Player p = Mob.ClosestPlayer(bot, 5);
