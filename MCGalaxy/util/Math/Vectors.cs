...
namespace MCGalaxy.Maths
{
    ...
    {
        public ushort X, Y, Z;
        public static Vec3U16 Zero = new(0),
            MinVal = new(ushort.MinValue),
        ...
        {
            return new((ushort)a.X, (ushort)a.Y, (ushort)a.Z);
        }
        public readonly int LengthSquared { get { return X * X + Y * Y + Z * Z; } }
        public readonly float Length { get { return (float)Math.Sqrt(X * X + Y * Y + Z * Z); } }
        public override readonly bool Equals(object obj)
        {
            return (obj is Vec3U16 u) && Equals(u);
        }
        public readonly bool Equals(Vec3U16 other)
        {
    ...
    public struct Vec3S32 : IEquatable<Vec3S32>
    {
        ...
        public readonly bool Equals(Vec3S32 other)
        {
            return X == other.X & Y == other.Y && Z == other.Z;
        }
        public override readonly int GetHashCode()
    ...
    public struct Vec3F32 : IEquatable<Vec3F32>
    {
        ...
        public readonly bool Equals(Vec3F32 other)
        {
            return X == other.X & Y == other.Y && Z == other.Z;
        }
