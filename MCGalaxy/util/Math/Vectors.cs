...
namespace MCGalaxy.Maths
{
    ...
    {
        public ushort X, Y, Z;
        public static Vec3U16 MinVal = new(ushort.MinValue, ushort.MinValue, ushort.MinValue),
            MaxVal = new(ushort.MaxValue, ushort.MaxValue, ushort.MaxValue);
    ...
    public struct Vec3S32
    {
        ...
        public static bool operator !=(Vec3S32 a, Vec3S32 b) => a.X != b.X || a.Y != b.Y || a.Z != b.Z;
        public override readonly bool Equals(object obj) => (obj is Vec3S32 s) && (X == s.X & Y == s.Y && Z == s.Z);
