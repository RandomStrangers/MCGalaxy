...
namespace MCGalaxy.Generator
{
    public static class AdvNoiseGen
    {
        ...
        {
            MapGen.Register("Billow", GenType.Advanced, GenBillow2D, MapGen.DEFAULT_HELP);
            MapGen.Register("RidgedMultifractal", GenType.Advanced, GenRidged2D, MapGen.DEFAULT_HELP);
            MapGen.Register("Perlin", GenType.Advanced, GenPerlin2D, MapGen.DEFAULT_HELP);
            MapGen.Register("Voronoi", GenType.Advanced, GenVoronoi, MapGen.DEFAULT_HELP);
            MapGen.Register("Perlin3D", GenType.Advanced, GenPerlin3D, MapGen.DEFAULT_HELP);
            MapGen.Register("Perlin3Dyadjust", GenType.Advanced, GenPerlin3DYAdjust, MapGen.DEFAULT_HELP);
