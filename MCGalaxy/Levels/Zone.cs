...
namespace MCGalaxy
{
    public sealed class ZoneConfig : AreaConfig
    {
        ...
        public string Color => Group.GetColor(BuildMin);
    }
    ...
    public sealed class ZoneAccessController : AccessController
    {
        ...
        public override List<string> Whitelisted => cfg.BuildWhitelist;
        public override List<string> Blacklisted => cfg.BuildBlacklist;
        protected override string ColoredName => "zone " + cfg.Color + cfg.Name;
        protected override string Action => "build in";
        protected override string ActionIng => "building in";
        protected override string Type => "build";
        protected override string MaxCmd => null;
