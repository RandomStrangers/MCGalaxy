...
namespace MCGalaxy.Commands.CPE
{
    internal static class CustomBlockCommand
    {
        ...
        static void ListHandler(Player p, string[] parts, BlockDefinitionsArgs args)
        {
            ...
            List<BlockDefinition> defsInScope = new();
        ...
        static void MessageNoBlock(Player p, ushort block, BlockDefinitionsArgs args)
        {
        ...
        static void MessageAlreadyBlock(Player p, ushort block, BlockDefinitionsArgs args)
        {
        ...
        static void ResetProps(BlockDefinitionsArgs args, ushort block)
        {
        ...
        static readonly Dictionary<string, string[]> helpSections = new() {
