...
namespace MCGalaxy.Modules.Games.ZS
{
    public partial class ZSGame : RoundsGame
    {
        ...
        static readonly ColumnDesc[] zsTable = new ColumnDesc[] {
            ...
            new("Name", ColumnType.Char, 20),
            new("TotalRounds", ColumnType.Int32),
            new("MaxRounds", ColumnType.Int32),
            new("TotalInfected", ColumnType.Int32),
            new("MaxInfected", ColumnType.Int32),
            // reserve space for possible future additions
            new("Additional1", ColumnType.Int32),
        };
