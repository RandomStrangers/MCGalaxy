...
namespace MCGalaxy.Modules.Relay.Discord
{
    ...
    public class DiscordBot : RelayBot
    {
        ...
        public override void ReloadConfig()
        {
            ...
            Logger.Log(6, "can-mention-everyone option is enabled in {0}, " +
        ...
        protected override void OnStart()
        {
            ...
            session = s;
            base.OnStart();
            OnPlayerConnectEvent.Register(HandlePlayerConnect, 0);
            OnPlayerDisconnectEvent.Register(HandlePlayerDisconnect, 0);
            OnPlayerActionEvent.Register(HandlePlayerAction, 0);
        }
        ...
        void HandlePlayerConnect(Player _) => UpdateDiscordStatus();
        void HandlePlayerDisconnect(Player _, string __) => UpdateDiscordStatus();
        void HandlePlayerAction(Player _, int action, string __, bool ___)
        {
        ...
        protected override string UnescapeFull(Player p) => BOLD + base.UnescapeFull(p) + BOLD;
        protected override string UnescapeNick(Player p) => BOLD + base.UnescapeNick(p) + BOLD;
        ...
        static string FormatRank(OnlineListEntry e) => string.Format(UNDERLINE + "{0}" + UNDERLINE + " (" + CODE + "{1}" + CODE + ")",
