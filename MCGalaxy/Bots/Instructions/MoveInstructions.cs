...
namespace MCGalaxy.Bots
{
    ...
    public class TeleportInstruction : BotInstruction
    {
        ...
        public override bool Execute(PlayerBot bot, InstructionData data)
        {
            ...
            bot.Pos = new(coords.X, coords.Y, coords.Z);
        ...
        public override InstructionData Parse(string[] args)
        {
            Coords coords = new()
            {
                X = NumberUtils.ParseInt32(args[1]),
                Y = NumberUtils.ParseInt32(args[2]),
                Z = NumberUtils.ParseInt32(args[3]),
                RotX = byte.Parse(args[4]),
                RotY = byte.Parse(args[5])
            };
