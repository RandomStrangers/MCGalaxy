...
namespace MCGalaxy
{
    public partial class NASCrafting
    {
        ...
        public static void ClearCraftingArea(NASLevel nl, ushort startX, ushort startY, ushort startZ, NASStation.NASOrientation ori)
        {
            bool WE = ori == NASStation.NASOrientation.WE;
            if (WE)
            {
                startX--;
            }
        ...
        public static NASBlock[,] GetArea(NASLevel nl, ushort startX, ushort startY, ushort startZ, NASStation.NASOrientation ori)
        {
        ...
        public class NASRecipe
        {
            ...
            public NASStation.NASStationType stationType = NASStation.NASStationType.Normal;
            public bool usesParentID = false,
                usesAlternateID = false,
                shapeless = false;
            public NASDrop drop;
            public NASRecipe() => recipes.Add(this);
