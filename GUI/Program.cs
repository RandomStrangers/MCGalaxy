    ...
    public static class Program
    {
        ...
        remake:
            try
            {
                ...
                if (foundView[4].Split(' ')[2].ToLower() == "true")
                {
                    ...
                    Console.Title = Server.name + " - MCGalaxy " + Server.Version1;
                    usingConsole = true;
                    handleComm();
                    ...
                    if (availableUpdateVersion > Server.Version)
                    {
                        ...
                        else
                        {
                            ...
                            else
                            {
                                ...
                                Console.WriteLine("Also update using the file at " + CLIEXELocation + " and placing it over the top of your current MCGalaxyCLI.exe");
        ...
        public static void PerformUpdate()
        {
            try
            {
                ...
                Client.DownloadFile(CLIEXELocation, "MCGalaxyCLI.update");
