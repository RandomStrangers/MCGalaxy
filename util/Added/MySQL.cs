...
namespace MCGalaxy
{
    public sealed class MySQLBackend : IDatabaseBackend
    {
        ...
        public override void CreateDatabase()
        {
            ...
            Database2.Do(sql, true, null, null);
        }
        ...
        public override bool TableExists(string table)
        {
            ...
            Database2.Iterate("SHOW TABLES WHERE " + column + " = @0",
                            record => found = true,
                            table);
            return found;
        }
        ...
        public override void PrintSchema(string table, TextWriter w)
        {
            ...
            Database2.Iterate("DESCRIBE `" + table + "`",
                            record => fields.Add(Database2.ParseFields(record)));
    ...
    sealed class MySQLReader : ISqlReader
    {
        ...
        string RawGetDateTime(int col)
        {
            ...
            return date.ToString(Database2.DateFormat);
        }
