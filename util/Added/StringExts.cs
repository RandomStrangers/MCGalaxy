...
namespace MCGalaxy
{
    ...
    public static class StringExts
    {
        ...
        public static string RemoveLastPlus2(this string str)
        {
            if (String.IsNullOrEmpty(str)) return str;
        ...
        public static bool IsCommentLine2(this string line)
        {
            return line.Length == 0 || line[0] == '#';
        }

        /// <summary> Returns whether all characters in the given string are also in the given alphabet </summary>
        public static bool ContainsAllIn2(this string str, string alphabet)
        {
