...
namespace MCGalaxy
{
    public sealed class SQLiteBackend : IDatabaseBackend
    {
        ...
        {
            return Database2.CountRows("sqlite_master",
        ...
        public override List<string> ColumnNames(string table)
        {
            ...
            Database2.Iterate("PRAGMA table_info(`" + table + "`)",
    ...
    sealed class MCGSQLiteConnection : SQLTest.SQLiteConnection
    {
