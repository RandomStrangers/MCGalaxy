    ...
    public sealed class CmdInfo : Command
    {
        ...
        public override void Use(Player p, string message)
        {
            ...
            else
            {
                ...
                Player.SendMessage(p, "This server runs on &bMCGalaxy" + Server.DefaultColor + ", which is based on &bMCForge/MCLawl" + Server.DefaultColor + ".");
                Player.SendMessage(p, "This server's version: &a" + Server.Version1);
